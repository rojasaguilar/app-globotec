            ...
            productos.filter((producto,index) => index<=2).map(producto => {
              return (
                <div className="bg-white p-2 rounded-xl space-x-4 grid grid-cols-11">
                  ...
                  <p className="text-sm col-span-2 bg-red-300 rounded-full h-6 p-2 w-fit items-center flex col-start-7">
                    {producto.pro_stock}
                  </p>
                  <p className="text-sm col-span-2  rounded-full h-6 p-2 items-center w-fit flex col-start-10">
                    {producto.pro_stockMinimo}
                  </p>
                </div>
              );
            })
